var __windowContext = function () {
    ...
    var _getWidthPercent = function (percent) {
        return canvas.width * percent;
    }

    var _getHeightPercent = function (percent) {
        return canvas.height * percent;
    }

    var _getSizePercent = function (widthPercent, heightPercent){
        return [_getWidthPercent(widthPercent), _getHeightPercent(heightPercent)];
    } 

    return {
        GetScreenCenter: _getScreenCenter,
        GetWidthPercent: _getWidthPercent,
        GetHeightPercent: _getHeightPercent,
        Resize: _resize,
        Canvas: canvas,
        Init: _init
    }
